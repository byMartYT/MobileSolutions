...
|------------- | ------------- | -------------|
|[**dbTestApiV1DbTestGet**](#dbtestapiv1dbtestget) | **GET** /api/v1/db-test | Db Test|
...
# **dbTestApiV1DbTestGet**
> any dbTestApiV1DbTestGet()
...
const { status, data } = await apiInstance.dbTestApiV1DbTestGet();
```
